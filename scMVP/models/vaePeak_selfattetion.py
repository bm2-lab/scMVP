...
from scMVP.models.modules import Encoder, DecoderSCVI, LinearDecoderSCVI, DecoderSCVI_nb, DecoderSCVI_mse, Encoder_l, Encoder_mse,\
    Encoder_nb, DecoderSCVI_Peak, DecoderSCVI_Peak_Selfattention, Encoder_nb_selfattention, DecoderSCVI_nb_Selfattention
...
# VAE model
class VAE_Peak_SelfAttention(nn.Module):
    ...
    def __init__(
        ...
        if self.reconstruction_loss == "mse":
            ...
            self.z_encoder = Encoder_nb_selfattention(
                n_input,
                n_latent,
                n_layers=n_layers,
                n_hidden=n_hidden,
...
class LDVAE(VAE_Peak_SelfAttention):
